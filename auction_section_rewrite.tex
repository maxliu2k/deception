...
%    Claude [-1.1,+4.5]  Gemini [-6.3,+0.8]); all still include 0.
%
...
%  6. Gemini is the worst-fit mimic (Delta -2.8, MAE 1.55) yet we claim "jumps don't
%     affect the win distribution" -- mild tension; fine to keep, note Gemini is the
%     soft spot.
